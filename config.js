...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  'STAR BOT',
  packname:  process.env.PACK_NAME || 'MADE BY EXCEL AMADI',
  ...
  caption :process.env.CAPTION || "\t*•ᴘᴏᴡᴇʀᴇᴅ ʙʏ ⭐sᴛᴀʀ-ᴍᴅ⭐•* ",   //*『sᴜʙsᴄʀɪʙᴇ • ʙʟᴀᴅᴇ ᴛᴇᴄʜ』*\n https://whatsapp.com/channel/0029Va9wmuz8F2pGIURwmo0m"),	
